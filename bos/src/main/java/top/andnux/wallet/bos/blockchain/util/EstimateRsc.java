package top.andnux.wallet.bos.blockchain.util;

import java.io.Serializable;

import top.andnux.wallet.bos.blockchain.chain.PackedTransaction;
import top.andnux.wallet.bos.blockchain.chain.SignedTransaction;

/**
 * Created by swapnibble on 2017-09-12.
 */

public class EstimateRsc implements Serializable {
...
//    }
//
//    public long estimateTrxNetUsageWords( final SignedTransaction txn, PackedTransactionRequest.CompressType compressType, int keyCount ){
//        if (tx_net_usage != 0) {
...
//
//        long packed_size_drift = PackedTransactionRequest.CompressType.none.equals( compressType ) ?
...
//
//        PackedTransactionRequest packedTransaction = new PackedTransactionRequest( txn );
//
